...
$webAppPath = Join-Path $projectRoot 'program\web\streamlit_app.py'
Write-Host '[Info] Starting Streamlit dashboard...'
& $pythonRunner.Exe @($pythonRunner.Args) -m streamlit run $webAppPath @Args
