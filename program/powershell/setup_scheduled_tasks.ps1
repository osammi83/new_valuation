...
$runDailyPath = Join-Path $projectRoot "program\powershell\run_daily.ps1"
$runEpsPath = Join-Path $projectRoot "program\powershell\run_eps_cache_refresh.ps1"
$runAssumptionsPath = Join-Path $projectRoot "program\powershell\run_assumptions_refresh.ps1"
